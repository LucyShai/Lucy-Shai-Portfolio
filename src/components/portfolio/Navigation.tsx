...
const socialLinks = [
  ...
  { name: "Email", icon: Mail, href: "mailto:kgorutla9@gmail.com" },
];
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-x-0 top-16 z-40 md:hidden bg-card/98 backdrop-blur-md border-b border-border"
          >
